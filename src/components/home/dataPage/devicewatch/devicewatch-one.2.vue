        ...
        <div class="chartview" v-if="moniterDataShow">
          <div id="diagram">
            <el-row class="lineBarDiv">
              ...
              <el-col :span="12">
                <div id="barChartDiv" style="min-width: 50%;height:200px;" ref="barChart"></div>
              </el-col>
            </el-row>
          </div>
        </div>
    ...
    mointorPointQueBt (item) {
      ...
      if (this.nodeSelected !== '') {
        ...
        let resizeLinechartviewContainer = function () {
          lineBox.style.height = document.body.clientHeight - 470 + 'px'
        }
        let barBox = document.getElementById('barChartDiv')
        let resizeBarchartviewContainer = function () {
          barBox.style.height = document.body.clientHeight - 470 + 'px'
        }
