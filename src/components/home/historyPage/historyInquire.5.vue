...
export default {
  ...
  methods: {
    ...
    pageUpBtn: function () {
      ...
      // ...判断上一页是back 还是 cache
      if (this.pageCurNum <= (this.pageRightNum + (this.pageLeftNum - 1) - 5)) {
        // back
      ...
      } else if (this.pageCurNum > (this.pageRightNum + (this.pageLeftNum - 1) - 5)) {
        // cache
    ...
    pageDownBtn: function () {
      ...
      // ...判断下一页是back 还是 cache
      if (this.pageCurNum > this.pageDownBackNum || this.pageCurNum > (this.pageRightNum + (this.pageLeftNum - 1))) {
        // back
        if (this.pageCurNum >= (this.pageRightNum + this.pageLeftNum) || this.pageLeftNum === 1) {
          if (this.cursorArr[this.pageCurNum - 1 - 1] !== undefined && !this.endTimeFlag) {
            console.log('下一页back')
            this.loadingFlag = true
            this.onenetNextHistoryQuery(this.cursorArr[this.pageCurNum - 1 - 1])
